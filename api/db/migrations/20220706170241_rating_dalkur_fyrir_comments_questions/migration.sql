...
INSERT INTO "new_AnswerComment" ("answerId", "body", "createdAt", "id", "level", "parentId", "userId") SELECT "answerId", "body", "createdAt", "id", "level", "parentId", "userId" FROM "AnswerComment";
...
INSERT INTO "new_Answer" ("createdAt", "id", "justification", "questionId", "title", "userId") SELECT "createdAt", "id", "justification", "questionId", "title", "userId" FROM "Answer";
DROP TABLE "Answer";
